...
url=https://gitlab.com/hmeng80/extensions/-/raw/main/multistalker-pro/py3.12/multi-stalkerpro-1.2-aarch64-bv.tar.gz
sleep 3
else
url=https://gitlab.com/hmeng80/extensions/-/raw/main/multistalker-pro/py3.12/multi-stalkerpro-1.2-aarch64-ape.tar.gz
sleep 3
fi;;
*)
echo "> your image python version: $python is not supported"
...
if [[ "$IMAGE" == "openvix" || "$IMAGE" == "openblackhole" ]]; then
url=https://gitlab.com/hmeng80/extensions/-/raw/main/multistalker-pro/py3.12/multi-stalkerpro-1.2-mips-bv.tar.gz
sleep 3
else
url=https://gitlab.com/hmeng80/extensions/-/raw/main/multistalker-pro/py3.12/multi-stalkerpro-1.2-mips-ape.tar.gz
sleep 3
fi;;
3.9.9)
url=https://gitlab.com/hmeng80/extensions/-/raw/main/multistalker-pro/py3.9.9/multi-stalkerpro-1.2-mips.tar.gz;;
*)
echo "> your image python version: $python is not supported"
sleep 3
exit 1
...
if [[ "$IMAGE" == "openvix" || "$IMAGE" == "openblackhole" ]]; then
url=https://gitlab.com/hmeng80/extensions/-/raw/main/multistalker-pro/py3.12/multi-stalkerpro-1.2-arm-bv.tar.gz
sleep 3
else
url=https://gitlab.com/hmeng80/extensions/-/raw/main/multistalker-pro/py3.12/multi-stalkerpro-1.2-arm-ape.tar.gz
sleep 3
fi;;
3.9.9)
url=https://gitlab.com/hmeng80/extensions/-/raw/main/multistalker-pro/py3.9.9/multi-stalkerpro-1.2-arm.tar.gz;;
*)
echo "> your image python version: $python is not supported"
sleep 3
exit 1
